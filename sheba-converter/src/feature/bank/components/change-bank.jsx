...
const ChangeBank = ({onBankSelected}) => {
    const banks = [
        ...
        {id: 4, name: "اقتصاد نوین", image: eghtesadnovinBank},
        {id: 5, name: "گردشگری", image: gardeshgariBank},
        {id: 6, name: "قوامین", image: ghavaminBank},
        {id: 7, name: "ایران زمین", image: iranzaminBank},
        {id: 8, name: "کارآفرین", image: karafarinBank},
        {id: 9, name: "کشاورزی", image: keshavarziBank},
        {id: 10, name: "خاورمیانه", image: khavarmiyanehBank},
        {id: 11, name: "مسکن", image: maskanBank},
        {id: 12, name: "مهر اقتصاد", image: mehrBank},
        {id: 13, name: "ملی", image: meliBank},
        {id: 14, name: "ملت", image: mellatBank},
        {id: 15, name: "پارسیان", image: parsianBank},
        {id: 16, name: "پاسارگاد", image: pasargadBank},
        {id: 17, name: "پست بانک", image: postBank},
        {id: 18, name: "رفاه", image: refahBank},
        {id: 19, name: "رسالت", image: resalatBank},
        {id: 20, name: "صادرات", image: saderatBank},
        {id: 21, name: "سامان", image: samanBank},
        {id: 22, name: "صنعت معدن", image: sanatmadanBank},
        {id: 23, name: "سرمایه", image: sarmayeBank},
        {id: 24, name: "سپه", image: sepahBank},
